...
class rrJob(object):
    ...
    def writeToXMLstart(self, submitOptions ):
        ...
        # Path to current Shotgun Toolkit config
        # self.subE(rootElement, "CustomSgTkPath", os.environ['TANK_CURRENT_PC']) This is wron
    ...
    def writeToXMLJob(self, rootElement):
        ...
        # Path to current project Shotgun Toolkit configuration
        self.subE(jobElement, "CustomSgTkPath", os.environ['TANK_CURRENT_PC'])
...
def submitJobsToRR(jobList,submitOptions):
    ...
    # tmpFileName = "/Users/amy/Desktop/rrSubmitNuke_3889.xml" # test
    ...
    print "SUBMITTER PATH: ", getRRSubmitterPath()
    print "TEMP FILENAME: ", tmpFileName
