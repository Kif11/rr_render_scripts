...
if ( ! $?RR_REDSHIFT_BASE ) then
   setenv RR_REDSHIFT_BASE "${rrSharedExeDir}Redshift_${rrJobRendererVersion}/Plugins/Maya"
endif
...
if ( ! $?RR_VRAY_BASE ) then
    setenv RR_VRAY_BASE "${rrSharedExeDir}vray${rrExeVersionMajor}/Plugins/Maya"
endif
